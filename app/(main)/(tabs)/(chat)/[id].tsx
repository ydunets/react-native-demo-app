...
const CHAT_CONTENT: Record<string, { name: string; messages: Array<{ text: string; sender: 'user' | 'other'; time: string }> }> = {
  '1': {
    name: 'Support Team',
    messages: [
      ...
      { text: 'Sure, I\'d be happy to help. What would you like to know?', sender: 'other', time: '10:06 AM' },
    ],
  },
  '2': {
    name: 'Dr. Smith',
    messages: [
      { text: 'Your appointment is confirmed for next Monday at 2 PM', sender: 'other', time: '9:00 AM' },
  ...
  '3': {
    name: 'Wellness Coach',
    messages: [
      { text: 'Great progress this week! Keep up the good work.', sender: 'other', time: 'Yesterday' },
    ...
    <>
        ...
        {chat.messages.map((msg, index) => (
          <View
            ...
            <View
              ...
              <Text
                className={msg.sender === 'user' ? 'text-white' : 'text-foreground'}>
                {msg.text}
              </Text>
              <Text
                variant="caption2"
                className={`mt-1 ${
                  msg.sender === 'user' ? 'text-white/70' : 'text-tertiary'
                }`}>
                {msg.time}
              </Text>
            </View>
      ...
      <View className="border-t border-border bg-background p-4">
        ...
        <Pressable
          ...
          className="mt-4 p-3 rounded-lg border border-border bg-card active:opacity-70">
          <View className="flex-row items-center gap-2">
            <Icon name="pencil" size={18} className="text-primary" />
