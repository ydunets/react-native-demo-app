    ...
    <>
      ...
      <SafeAreaView className="flex-1 bg-black" edges={['top', 'bottom']}>
        ...
        <Text variant="body" className="text-center text-white/70">
          This is a full-screen modal (presentation: "fullScreenModal"). It covers the entire screen and is typically used for lock screens, onboarding, or critical overlays.
        </Text>
